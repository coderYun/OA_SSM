...
<%@ page import="com.immoc.oa.global.Contant" %>
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <c:forEach items="${list}" var="cv">
                            <tr class="message-unread">
                                ...
                                <td>
                                    <c:if test="${cv.status==Contant.CLAIMVOUCHER_CREATED || cv.status==Contant==Contant.CLAIMVOUCHER_BACK}">
                                       <a href="/claim_voucher/to_update?id=${cv.id}">修改</a>
                                       <a href="/claim_voucher/submit?id=${cv.id}">提交</a>
                                    </c:if>
                                    <c:if test="${cv.status==Contant.CLAIMVOUCHER_SUBMIT || cv.status==Contant==Contant.CLAIMVOUCHER_RECHECK}">
